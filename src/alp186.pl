...
positions([Head|Tail],Pos,Listofwords) :-
     ...
     ifthenelse( ((lex(Head,_,_), NewHead=Head, not(member(Head,Bag_words)) );
                  ...
                  (atom_concat(First,Second,Head),            % only Head is known - atom divisions are put forward by atom_concat
                   ...
                   lex(Known1,v,_),                             % the full form is registered as a verb form
                   NewHead=Known1);
...
[mapped(adj,[from:A,to:B|FS]),
 ...
 map(adjp,[cat:adjp,pathlist:[p(A,B)],distance:[0],hp:[p(A,B)],
             case:C,number:N, gender:G,lex:Lex,type:Type,w:1,c_str:Lex])].
...
% lex(prope,    adv,[lex:prope,      pos:adv,type:adjbound, sem:eval]).
 ...
 map(adjp,[cat:adjp,pathlist:[p(A,B),p(B,C)],distance:[0],hp:[p(A,B)],
             case:Case,number:N, gender:G,lex:Lexadj,type:Typeadj,w:1,c_str:[Lexadv,Lexadj]])].
...
% lex(isti, adj, [pos:adj, txt:isti, lex:iste,gender:masc,type:tool,case:nom, number:pl]).
 ...
 distance([p(A,B)],PADJ,Dis),
 append([p(A,B)],PADJ,PADJ2),
 map(adjp,[cat:adjp,pathlist:PADJ2,distance:[Dis],hp:HP,
             case:C,number:N, gender:G,lex:LexADJ,type:Type,w:2,c_str:[LexTOOL,LexADJ]])].
...
[mapped(adj,[from:A,to:B|FS]),
 ...
 constraint([type:finite,class:m,pathlist:PLSub,distance:Dis, gap:[],
             ...
             mood:subjunctive, tense:TenseSub,w:W1,c_str:HeadSub],SubClause),
 ...
 map(adjp,[cat:adjp,pathlist:Sorted,distance:Dis,hp:[p(A,B)],
             case:Case,number:N, gender:G,lex:Lex,type:Type,w:Weight,
             c_str:[Lex,comp_cplt:[ut,HeadSub]]])].
...
[ mapped(gdiv,[from:A,to:B|FS]),
 ...
 map(adjp,[cat:adjp,pathlist:[p(A,B)],distance:[0],hp:[p(A,B)],
             case:C,number:N, gender:G,type:gdiv,lex:Txt,w:1,c_str:Txt]) ].
...
[mapped(adjp,Fadjp),
 ...
 map(adjp,[pathlist:Sorted,hp:HL1,distance:[Dis],
           ...
           case:C,c_str:[head:Fadjp,arg:Tree]])].              % the constituent structure is the head adj followed by its argument
...
map(participle_clause,[pathlist:NSorted,hp:[p(A,B)],distance:[NDistance],
           ...
           number:Nb,gender:G, lex:Lex,
           case:C,c_str:[present_participle,Lex,NST]]),
...
[mapped(p_p,[from:X,to:Y|FS]),               % past participle of a deponent verb
 ...
 map(participle_clause,[pathlist:NSorted,hp:[p(X,Y)],distance:[NDistance],
           ...
           number:Nb,gender:G, lex:Lex,
           case:C,c_str:[deponent_p_p,Lex,NST]])].
...
map(participle_clause,[pathlist:NSorted,hp:[p(X,Y)],distance:[NDistance],
           ...
           number:Nb,gender:G, lex:Lex,
           case:C,c_str:[past_participle,Lex,NST]]),
...
[mapped(p_f,[from:A,to:B|FS]),                                     % p_f is future participle
 ...
 full_expansions(FE),
  ...
  myplus(W,WExpandN,WW),
           ...
           number:Nb,gender:G, lex:Lex,
           case:C,c_str:[future_participle,Lex,NST]]),
  ...
  ifthen( (G=masc;G=fem;G=or([masc,fem])),  % only map as NP if masc/fem
         ...
         map(np,[pathlist:NSorted,hp:[p(A,B)],
           ...
           number:Nb,person:_,gender:G, type:clausal,lex:Lex,lextype:full,
           case:C,w:WW,
           c_str:[future_participle,Lex,NST]]))    ].
...
[mapped(adv,[from:A,to:B|FS]),
 ...
 map(advp,[cat:advp,pathlist:Sorted,distance:Dis,hp:[p(A,B)],
             lex:Lex,type:Type,w:Weight,sem:Sem,
             c_str:[Lex,comp_cplt:[ut,HeadSub]]])].
...
[mapped(adj,[from:A,to:B|FS]),
 ...
 (Gender=masc;Gender=fem),
  ...
  map(noun,[from:A,to:B,pos:noun,origin:adj,txt:Text,lex:Lex,case:C,gender:Gender,class:common,ab:no,number:Number,sem:[hum],c_str:Lex]) ].
...
[mapped(adj,[from:A,to:B|FS]),
 ...
 map(noun,[from:A,to:B,pos:noun,origin:adj,txt:Text,lex:Lex,case:C,gender:neuter,class:common,ab:no,number:Nb,sem:[abstract,thing],c_str:Lex]) ].
...
[mapped(noun,[from:A, to:B|FSnoun]),
 ...
 constraint([number:sing,gender:fem,case:Case,lex:publicus],FSadj),
  map(np,[pathlist:[p(A,B),p(B,C)],hp:[p(A,B)],index:i(p(A,B)),distance:[0],cat:np,class:common,sem:[abstract,hum],
          ...
          case:Case,w:3,c_str:res_publica]) ].
...
% map(noun,[from:A,to:C,pos:noun,lex:res_publica,class:common,sem:[abstract,hum],txt:res_publica,
 %           number:sing,gender:fem,case:Case,c_str:res_publica])
% ].
...
[mapped(noun,[from:B, to:C|FSnoun]),
 ...
 map(np,[pathlist:[p(A,B),p(B,C)],hp:[p(B,C)],index:i(p(B,C)),distance:[0],cat:np,class:Class,sem:Sem,
          ...
          case:Case,w:1,c_str:[head:FSnoun,adjp:FSadj]])].
...
[mapped(noun,[from:A, to:B|FSnoun]),
 ...
 ifthen(Distance=1, relaxedadjacent1_cgn(Padj,[p(A,B)],CaseOut,Gender,Nb)),
  ...
  map(np,[pathlist:Sorted,hp:[p(A,B)],index:i(p(A,B)),distance:[Distance],
            cat:np,class:Class,sem:Sem,
            number:Nb,person:3,gender:Gender,type:core,lex:LexNoun,lextype:full,
            case:CaseOut,w:Weight,c_str:[head:FSnounp,adjp:FSadj]])].
...
[mapped(np,FSnp),
 ...
 constraint([number:Nb,gender:Gender,case:Case2,type:Type_pp,lex:_,w:W],FSpp),
...
contiguous(Sorted),
 ...
 map(np,[pathlist:Sorted,hp:HPnp,index:Index,distance:Distance,
           ...
           c_str:[head:FSnp,participle_clause:FSpp]]) ].
...
[mapped(noun,[from:A,to:B|FS1]),
 ...
 map(np,[pathlist:[p(A,B)],hp:[p(A,B)],index:i(p(A,B)),distance:[0],
           ...
           number:Nb,person:3,gender:G,type:core,case:C,w:1,c_str:LexNoun])].
...
[ mapped(noun,[from:A,to:B|FS1]),
 ...
 map(address,[pathlist:Path2,hp:[p(A,B)],index:i(p(A,B)),distance:[0],
           ...
           number:Nb,person:P,gender:G,type:core,case:voc,w:2, c_str:[address:LexNoun]])].
...
[ mapped(np,FSNP),
 constraint([pathlist:Path,hp:HP,index:Index,number:Number,gender:G, case:Case,lex:LexNoun,
              sem:Sem, distance:Dis,class:Class, c_str:CSTR],FSNP),
...
(Class=common;Class=proper),
 ...
 map(address,[pathlist:Sorted,hp:HP,index:Index,distance:Dis,
           ...
           number:Number,person:2,gender:G,type:core,case:voc,w:Weight, c_str:[address:CSTR]])].
...
% 
 ...
 map(address,[pathlist:Path2,hp:[p(A,B)],index:i(p(A,B)),distance:[0],
           ...
           number:Nb,person:2,gender:G,type:core,case:voc,w:12, c_str:[address:LexNoun]])].
...
[mapped(print,[from:A,to:B|FS1]),   % PRINT: interrogative pronouns as a lexical class
 ...
 map(np,[pathlist:[p(A,B)],hp:[p(A,B)],index:i(p(A,B)),distance:[0],
           ...
           number:Nb,person:3,gender:G,type:int,case:C,w:1,c_str:Lex])].                         % we register the interrogative nature
...
[mapped(prdem,[from:A,to:B|FS1]),              % PRDEM : ditto for demonstrative pronouns
 ...
 map(np,[pathlist:[p(A,B)],hp:[p(A,B)],index:i(p(A,B)),distance:[0],
           ...
           number:Nb,person:3,gender:G,type:core,case:C,w:1,c_str:Lex])].
...
[(Typepro=prdem;Typepro=prindef;Typepro=print),     % demonstrative, indefinite or interrogative pronoun
 ...
 adj(LexAdj,_,1,_,_,_),           % 1 indicates second declension adj
 adjacent([p(A,B)],Padj),
...
[(Typepro=prdem;Typepro=prindef;Typepro=print),      % demonstrative, indefinite or interrogative pronoun
 ...
 map(np,[pathlist:Path,hp:[p(A,B)],index:i(p(A,B)),distance:[0],
           cat:np,sem:Sem,lex:Lex,class:Typepro,type:Type,            % class inherited from pronoun
           number:N,person:3,gender:G,case:C,w:Weight1,c_str:[Lex,FSnp]])].
...
[(Typepro=prdem;Typepro=prindef;Typepro=print;Typepro=prpers),     % demonstrative, indefinite, interrogative or personal pronoun
 ...
 map(np,[pathlist:Path,hp:[p(A,B)],index:i(p(A,B)),distance:[0],
           ...
           number:Numberpro,person:3,gender:or([masc,fem]),case:C,w:Weight1,c_str:[Lex,FSnp]])].
...
[mapped(prpers,[from:A,to:B|FS1]),       %  PRPERS
 ...
 map(np,[pathlist:[p(A,B)],hp:[p(A,B)],index:i(p(A,B)),distance:[0],
           ...
           number:Nb,person:Person,gender:G,type:core,case:C,w:1,c_str:Lex])].
...
[core,np22] --->
[mapped(prpers,[from:A,to:B|FS1]),
 constraint([number:Nb,gender:G, case:C,sem:Sem, lex:pp3refl],FS1),               % the lex value catches the reflexive pronouns
                      % of the third person
 mapped(adjp,FSadj),
       constraint([pathlist:[p(B,X)],number:Nbi,gender:Gi,case:C,lex:ipse],FSadj),  % 'ipse' follows : 'se ipsum' not * ipsum se
             funify([number:Nb],[number:Nbi],[number:Nbres]),
                                                                                   % the reflex have Or-sets for gender and number;
                       % 'ipse' is more precise
 ...
 map(np,[pathlist:[p(A,B),p(B,X)],hp:[p(A,B)],index:_,distance:[0],         % the index will be instantiated when the parse is ready for output
           ...
           number:Nbres,person:3,gender:Gres,type:core,case:C,w:1,c_str:pp3refl])].
...
[mapped(prpers,[from:A,to:B|FS1]),
 ...
 map(np,[pathlist:[p(A,B)],hp:[p(A,B)],index:_,distance:[0],         % the index will be instantiated when the parse is ready for output
           ...
           number:Nb,person:3,gender:G,type:core,case:C,w:1,c_str:pp3refl])].
...
map(np,[pathlist:[p(0,1)],hp:[p(0,1)],index:i(p(0,1)),distance:[0],
           ...
           number:Number,person:3,gender:Gender,type:core,w:1,case:Case,c_str:linking_relative])].
...
[mapped(np,Fnp1), % the head
 ...
 constraint([pathlist:PL2, hp:[p(G1,G2)],distance:[Distnp2],w:W2,case:gen],Fnp2),  % case must be genitive
 ...
 ifthenelse(contiguous(Sorted),Weight=1.5,Weight=1), % NOT an error - contiguousness is both a redeeming factor in case of distance
...
[mapped(noun,[from:A, to:B|FSnoun1]),
 ...
 map(np,[pathlist:[p(A,B),p(B,C)],hp:[p(A,B)],index:i(p(A,B)),distance:[0],cat:np,class:common,sem:Sem1,
          ...
          case:Case,w:(0.5), c_str:[apposition_pair,head:Lex1,head:Lex2]])].
...
[mapped(noun,[from:A, to:B|FSnoun]),
 ...
 constraint([pathlist:Path,number:N,case:Case,gender:G,class:common,
             sem:Sem2,lex:Lex2, distance:Distance,w:Weight,c_str:C_str],FSNP),
 ...
 map(np,[pathlist:Sorted,hp:[p(A,B)],index:i(p(A,B)),distance:Distance,cat:np,class:common,sem:Sem1,
          number:N,person:3,gender:G,type:core,lex:Lex1,lextype:full,
          case:Case,w:Weight, c_str:[apposition_pair,head:Lex1,apposition:C_str]])].
...
[mapped(np,FSNP1),
 ...
 constraint([pathlist:Path1,hp:HP,index:Index,number:N,case:Case,gender:G1,class:common,
             sem:Sem1,lex:Lex1, distance:[Distance1],w:Weight1,c_str:C_str1],FSNP1),

 constraint([pathlist:Path2,number:N,case:Case,gender:G2,class:common,
             sem:Sem2,lex:Lex2, distance:[Distance2],w:Weight2,c_str:C_str2],FSNP2),
 ...
 map(np,[pathlist:Sorted,hp:HP,index:Index,distance:[Distance],
         cat:np,class:common,sem:Sem1,
          ...
          case:Case,w:Weight1, c_str:[apposition_pair,head:C_str1,apposition:C_str2]])].
...
[mapped(np,HeadNP), % the head NP
 ...
 ( constraint([type:finite,class:s,gap:[],argbound:no,
               pathlist:PL2, distance:[Distpred],mood:indicative, w:Wsub,c_str:[quod,_]],ApposedPred);
   constraint([type:finite,class:s,gap:[],argbound:no,
               pathlist:PL2, distance:[Distpred],mood:subjunctive, w:Wsub,c_str:[ut,_]],ApposedPred)
 ),
...
[ % the NP
 ...
 constraint([number:Nb,gender:G,person:P,pathlist:PL2,distance:[Distrel], constraints:Constraints,w:W],FS2),
...
[finite,np32a] --->
 ...
 map(pred,[cat:pred,
              ...
              flagint:_,
              c_str:[illocutionary_force:existential,vg:FSverb|FS2]])].
...
[mapped(np,NP),
 constraint([pathlist:PL,lextype:full,type:Type,
           case:abl,lex:Lex,c_str:C_str, w:Weight],NP),
% Weight <3, % cannot be heavy if built as an adjunct
 ...
 map(adjunct,[pathlist:PL,distance:[0],class:adjunct,value:About,type:Type,w:0,c_str:C_str])].
...
[ mapped(p_p,[from:A,to:B|FSpp]),   % the past participle
  ...
  constraint([number:pl, gender:neuter, case:abl, lex:Clex],FSgdiv), % agreement checks
   ...
   map(aa,[   pathlist:Path_aa,
              distance:[0],
              w:MW,
              c_str:[lex:Lex,pp:FSpp,gdiv:FSgdiv]])].
...
% to retrieve verb-object relations
 ...
 [mapped(np,FSNP),
  constraint([case:abl,pathlist:Sorted,hp:HPnp,index:Index,distance:Distance,
           ...
           number:Nb,person:Person,gender:Gender,type:core,lex:LexNoun,lextype:full,   % person to be left open or read from np
           w:Weight,
           c_str:[head:FSnp,participle_clause:FSpp]], FSNP),
   Type_pp \= ppcentered,
...
[ ifthen((member(V,[v,p_f,p_p,gdiv]), mapped(V,_)),fail),
  ...
  map(pred,[cat:pred,argbound:no,class:m,type:finite,gap:[],  pathlist:AllPaths, distance:[0],
              w:Weight,c_str:[nominal_pred,subject:FSnp,predicative:FSadj,adjunct:ExpandT]])].
...
[ ifthen((member(V,[v,p_f,p_p,gdiv]), mapped(V,_)),fail),
  ...
  map(pred,[cat:pred,argbound:no,class:m,type:finite,gap:[],  pathlist:Sorted, distance:[0],
              w:Weight,c_str:[nominal_pred,subject:FSnp1,predicative:FSnp2]])].
...
[ ifthen((member(V,[v,p_f,p_p,gdiv]), mapped(V,_)),fail),
  ...
  map(pred,[cat:pred,argbound:no,class:m,type:finite,gap:[],  pathlist:Sorted, distance:[0],
              w:Weight,c_str:[nominal_pred,subject:FSnp,predicative:FSpp]])].
...
[ ifthen((member(V,[v,p_f,p_p,gdiv]), mapped(V,_)),fail),
 ...
 map(pred,[cat:pred,argbound:no,class:m,type:finite,gap:[],  pathlist:Sorted, distance:[Dis],
              w:Weight,c_str:[exclamation, subject:FSnp,predicative:FSadjp]]) ].
...
[
 ...
 map(pred,[cat:pred,argbound:no,class:m,type:finite,gap:[],  pathlist:Sorted, distance:[Dis],
              w:Weight,c_str:[exclamation, subject:FSnp,predicative:FSadjp,C_str_FreeSub]])].
...
map(pred,[cat:pred,type:finite,pathlist:PLtot,distance:Distance,
            ...
            add:Add,
            flagint:no,
            c_str:[illocutionary_force:prohibition,Cstr]])].  % we mention the illocutionary force in the parse tree
...
map(pred,[cat:pred,type:finite,pathlist:PLtot,distance:Distance,
            ...
            gap:[],w:WB,add:Add,
            flagint:no,
            c_str:[illocutionary_force:prohibition,Cstr]])].
...
[ (Function=subject; Function=object; Function=i_object;Function=object_i;Function=adjunct),
 ...
 constraint([c_str:C_str],FS2),      % getting at the args
...
map(np,[pathlist:PL,hp:[],distance:[Distance],
             ...
             c_str:[head:[lex:dummy_np, number:sing,gender:masc,person:3,index:_,
...
[mapped(relative,[from:A, to:_|FSrelative]),     % the relative pronoun opens the subject np
 ...
 constraint([pathlist:PLnoun,distance:[Distancenoun],
             type:core, case:nom,
             index:_,
             c_str:[head:LexNoun,participle_clause:FSpp]],NP), % c_str value indicates we have a np+participle clause
                          % quem amans rex
 ...
 map(relative_clause,[pathlist:PL,
      ...
      mood:Mood, tense:Tense,
                        constraints:[],     % no constraint to be imposed on the antecedent
                        w:Weight,
                        c_str:[head:[LexNoun,participle_clause:FSpp], rel_clause:C_str]]) ].
...
[mapped(coord,[from:X,to:Y|Fcoord]),
 ...
 map(adjp,[cat:adjp,pathlist:Sorted,hp:HL,distance:[Distance],
             ...
             c_str:[head:Fadj1,coord:Coord,head:Fadj2]])
 % map(flags,nocoord2)
].
...
[mapped(coord,[from:X,to:Y|Fcoord]),
 ...
 map(advp,[cat:advp,pathlist:Sorted,distance:[Distance],
             ...
             c_str:[head:Lex1,coord:Coord,head:Lex2]]),
map(flags,nocoord2)].
...
[mapped(coord,[from:X,to:Y|Fcoord]),
 ...
 constraint([distance:[Dis1],w:Weight1,value:Value,c_str:C_str1],Fadjunct1),
 constraint([distance:[Dis2],w:Weight2,value:_,c_str:C_str2],Fadjunct2),
 ...
 map(adjunct,[pathlist:Sorted,distance:[Distance],
             ...
             c_str:[head:C_str1,coord:Coord,head:C_str2]]),
map(flags,nocoord2)].
...
map(np,[pathlist:Sorted, hp:HL1,index:i(HL),distance:[Distance],
           ...
           c_str:[head:Fnp1,coord:Coord, head:Fnp2]]),
map(flags,nocoord2)].
...
[mapped(coord,[from:X,to:Y|Fcoord]),  % we have a coordinator somewhere in the string
 ...
 constraint([distance:[Distpp2],w:W2,c_str:Head2],Fpp2),
 ...
 map(pp,[pathlist:Sorted, hp:HL, distance:[Distance],index:_,
           ...
           w:Weight,
           c_str:[head:Head1,coord:Coord, head:Head2]]),
map(flags,nocoord2)].
...
% we copy voice mood and tense from the first verb
  ...
  map(vgpos,[cat:vg,class:Class, voice:Voice,type:Type,pathlist:[p(A,B),p(B,C),p(C,D)],hp:[p(A,B),p(C,D)],
              ...
              c_str:[head:Fverb1,coord:Coord,head:Fverb2]]),
map(flags,nocoord2)].
...
constraint([hp:HL1,distance:[Dist1],number:N1,gender:G1,case:C1,w:W1, c_str:C_str1, type:Type, lex:Lex], Fpc1),
constraint([ hp:HL2,distance:[Dist2],number:N1,gender:G1,case:C1,w:W2, c_str:C_str2], Fpc2),
...
map(participle_clause,[pathlist:Sorted, hp:HL,distance:[Distance],
           ...
           c_str:[C_str1,coord:Coord, C_str2]])].
...
constraint([distance:[Dist1],local_case:Case,w:W1, c_str:C_str1, type:gerund], FG1),
constraint([distance:[Dist2],local_case:Case,w:W2, c_str:C_str2, type:gerund], FG2),
...
map(pred,[cat:pred,type:gerund, class:m,    % type:gerund is how we specify them in args and adjuncts
              ...
              % local_case to store the case of the gerund
               ...
               gender:neuter,
               pathlist:Sorted, distance:[Distance],
               gap:[],w:Weight,c_str:[C_str1,coord:Coord, C_str2]])].
...
[mapped(coord,[from:X,to:Y|Fcoord]),     % making sure we have a coordinator
 ...
 mapped(aa,FAA2),
 FAA1 \= FAA2,
 constraint([pathlist:PL1, distance:[Dist1],w:W1, c_str:C_str1], FAA1),
 constraint([pathlist:PL2, distance:[Dist2],w:W2, c_str:C_str2], FAA2),
  Xminus1 is X-1,
...
[mapped(coord,[from:X,to:Y|Fcoord]),
 ...
 constraint([type:nonfinite,mood:Mood,tense:Tense,
            distance:[Distp1],gap:Gap1,w:W1,c_str:Head1],Fp1),
 constraint([type:nonfinite,mood:Mood,
             distance:[Distp2],gap:Gap2,w:W2,c_str:Head2],Fp2),
...
[ mapped(coord,[from:X, to:Y|FS2]),
 ...
 GAPARG2=[gap:[type:_,
               index:Index,       % gap sharing allows proper indexing in the c_str
               function:Function2,
               Function2:[e:Index],
               constraints:_
                           ]],
 ...
 % Weight is W1+W2+3,  % bonus for greater cohesion - 2 relative clauses with the same antecedent
  ...
  map(relative_clause,[pathlist:Sorted,
                         ...
                         w:Weight,
                         c_str:[rel_clause:C_str1, coord:Coord,
                                rel_clause:C_str2]]) ].
...
% Both 'ne' and 'censes' are outsiders
...
ifthenelse(Psubj=3,W=(-1),W=0),     % the penalty applies only to third person subjects
...
[recorded(out,Lists,_),
 ...
 setof(Rating-Parse,
            ...
            constraint([cat:pred,argbound:no,class:m,pathlist:Pathlist,type:finite,distance:[Distance],gap:[],w:Weight,c_str:Parse],Pred),
