...
go :- nl,
     ...
     % writing a file VOCFILE containing the vocabulary in expanded format:
                                      ...
                                      told,
                                      tell(user),
                                      % to be used for debugging purposes after sorting with 'sort' (e.g. sort vocfile > alplex.pl)
...
noun(3,masc,finis,fin,ium,class:common, ab:no, sem:[thing,loc],[nb:sg]).
...
% nominative f
asserta(lex(FNmfnsg,adj,[pos:adj,txt:FNmfsg,lex:FNmfnsg, type:Type,N, case:nom, gender:fem, number:sing, degree:pos,sem:Sem])),
% accusative f
